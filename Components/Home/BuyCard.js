...
export default function BuyCard() {
  return (
    <>
      <div
        className="w-[100%]  flex flex-col-reverse md:flex-row rounded-[14px]"
        style={{
          background:
      ...
      >
        ...
        <div className="w-full md:w-[43%] p-3  ">
          <p className="text-[20px] md:text-[28px] xl:text-[39px] uppercase">
            Lorem Ipsum &nbsp;{" "}
            <span style={{ color: "#E18949" }}> dummy text</span>&nbsp; PRESALE
          </p>
